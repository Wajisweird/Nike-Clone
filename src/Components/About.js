    ...
    <div>
      <div className="container">
        ...
        <div className="row  d-flex align-items-center mt-5" id="responsive">
          <div className="col-6" data-aos="fade-right" data-aos-duration="4000" id="football">
          ...
          <div className="col-6 text-center" id="ballText">
            ...
            <br />
            <p className="textera text-white-50" data-aos="fade-left" data-aos-duration="4000">
              ...
              opinion. Impossible is not a declaration. <br />It’s a dare. Impossible
